            ...
            <div className="relative px-4 sm:px-10 md:px-12 lg:px-14">
                <div className="w-full md:w-1/2 lg:w-[45%] flex flex-col justify-center">
                    ...
                    <div className="flex gap-x-5 mt-8">
                        <Link href="/quote" className="transform hover:-translate-y-2 text-sm md:text-base bg-orange border-orange hover:text-orange border-2 p-2 md:px-4 lg:px-8 md:py-3 text-white duration-500 hover:bg-white">
                            Request Quote
                        </Link>
                        <Link href="/tracking" className="transform hover:-translate-y-2 text-sm md:text-base bg-orange border-orange hover:text-orange border-2 p-2 md:px-4 lg:px-8 md:py-3 text-white duration-500 hover:bg-white">
                            Track Delivery
                        </Link>
                    </div>
                </div>
